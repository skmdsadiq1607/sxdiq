    ...
    <div className="flex-1 flex gap-6 items-center">
      {projects.map((project, i) => (
        <motion.div
          ...
          className="w-[420px] shrink-0 border border-border bg-card flex flex-col justify-between h-[65vh] group transition-all duration-300 hover:border-foreground"
            ...
            <div>
              ...
              <div className="flex gap-3">
                <a 
                  ...
                  target="_blank" 
                  rel="noreferrer" 
                  className="solid-btn-inverted py-2.5 px-5 text-[10px]"
                >
                ...
                <a 
                  ...
                  target="_blank" 
                  rel="noreferrer" 
                  className="solid-btn py-2.5 px-5 text-[10px]"
                >
